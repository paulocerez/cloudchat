      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="flex items-center gap-2">
            <span className={`h-9 w-9 shrink-0 rounded-md ${tone(color).soft}`}>
              <span className={`block m-[0.6875rem] h-[0.875rem] w-[0.875rem] rounded-md ${tone(color).swatch}`} />
            </span>
            <input
              autoFocus
              value={name}
      ...
      {mode.view === 'form' ? (
        ...
        <>
          ...
          <div className="flex flex-col gap-1 mb-3">
              ...
              {list.map((h) => (
                <button
                  ...
                  className="flex items-center gap-2.5 px-2 py-2 -mx-2 rounded-md text-left hover:bg-gray-50 transition-colors"
                >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 rounded-md text-sm font-medium bg-gray-900 text-white hover:bg-gray-800 active:scale-[0.97] transition-all"
          >
