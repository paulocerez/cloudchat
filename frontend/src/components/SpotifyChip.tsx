...
export function SpotifyChip({ link }: { link: SpotifyLink }) {
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-1.5 max-w-full px-2 py-1 rounded-md bg-green-50 text-green-700 text-xs font-medium hover:bg-green-100 transition-colors"
    >
      <SpotifyGlyph />
