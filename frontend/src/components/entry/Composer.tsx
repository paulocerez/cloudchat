    ...
    <div className="fixed bottom-0 inset-x-0 z-40 border-t border-gray-900/[0.07] bg-white/90 backdrop-blur-xl">
      ...
      >
        ...
        <input
          ...
          className="flex-1 min-w-0 h-10 text-base sm:text-sm text-[#241F2E] rounded-md surface-solid px-4 placeholder:text-[#94949E] focus:outline-none focus:ring-2 focus:ring-[#241F2E]/70 transition-shadow"
        />
