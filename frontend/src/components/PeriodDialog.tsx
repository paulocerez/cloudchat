        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-sm border border-gray-200 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-900/10 focus:border-gray-300"
            />
          </div>
          <div>
      ...
      <div className="flex items-center justify-between gap-2 mt-6">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={onClose}
            className="px-3 py-2 rounded-sm text-sm font-medium text-gray-500 hover:bg-gray-500/10 active:scale-[0.97] transition-all"
          >
            Cancel
          </button>
          <button
