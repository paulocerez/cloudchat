              ...
              <div className="flex flex-wrap gap-2">
                {summary.entryDates.map((date: string) => (
                  <Link
                    ...
                    to="/entry/$date"
                    params={{ date }}
                    className="text-xs border border-gray-200 hover:border-gray-900 hover:text-gray-900 rounded-md px-3 py-1.5 text-gray-500 transition-all duration-150 hover:-translate-y-0.5"
                  >
                    {date}
                  </Link>
                ))}
