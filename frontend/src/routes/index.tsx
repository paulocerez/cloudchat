        ...
        actions={
          <>
            ...
            <Link
              ...
              title="Go to today"
              className="h-9 px-3 inline-flex items-center rounded-md surface-solid text-[13px] font-semibold text-[#17171C] hover:bg-gray-50 active:scale-[0.96] transition-transform"
            >
              Today
            </Link>
...
function StreakBadge({ entries }: { entries: JournalEntry[] }) {
  ...
  return (
    <span
      ...
      className="shrink-0 inline-flex items-center gap-1.5 h-9 px-2.5 rounded-md bg-orange-50 text-orange-600 text-xs font-medium tabular-nums"
    >
          ...
          <div className="order-6 sm:order-none flex flex-col items-start sm:items-end gap-1.5">
            {mapUrl && (
              <img
                ...
                alt="Map preview"
                loading="lazy"
                className="w-40 h-[90px] object-cover rounded-md border border-gray-200 bg-gray-100"
              />
            )}
    ...
    <div className="divide-y divide-gray-100">
      {[1, 2, 3].map((i) => (
        <div key={i} className="flex gap-4 py-4 animate-pulse">
          <div className="w-0.5 h-12 bg-gray-100 rounded-md shrink-0 mt-1" />
          <div className="flex-1">
            <div className="h-2.5 bg-gray-100 rounded-md w-28 mb-2" />
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 animate-fade-up select-none">
      <div className="relative mb-6">
        ...
        <span className="absolute -top-1 -right-1 w-4 h-4 rounded-md bg-green-400 border-2 border-white" />
      </div>
